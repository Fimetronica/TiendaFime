...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary" style="background-color: rgb(110, 143, 181);">
	<a class="navbar-brand" href="index.php" onclick="<?php echo session_destroy(); ?>">
...
<!-- Generator: Adobe Illustrator 19.0.0, SVG Export Plug-In . SVG Version: 6.00 Build 0) -->
	...
	<div class="collapse navbar-collapse" id="navbarNav">
		<ul class="navbar-nav">
			<li class="nav-item "><a class="nav-link" href="index.php" onclick="<?php echo session_destroy(); ?>">Inicio</a></li>
			<li class="nav-item "><a class="nav-link" href="Contacto.php" onclick="<?php echo session_destroy(); ?>">Contacto</a></li>
		<!--	<li class="nav-item "><a class="nav-link" href="Galería.html">Videos</a></li>
			...
			<li class="nav-item "><a class="nav-link" href="Productos.php" onclick="<?php echo session_destroy(); ?>">Productos</a></li>
		 </ul>
	</div>
...
<main>
    <div class="container">
         <img src="https://th.bing.com/th/id/R.c44eb4ddaba61ae9233dd1cb0a2e2535?rik=g5OHUWESmeAQlA&pid=ImgRaw&r=0" height="550px">
        <div class="row">
            <div class="col-12">
                <br>
                ...
                <div class="table-responsive">
                 ...
                 <div class="d-grid gap-2 col-2 mx-auto">
                    <a href="Productos.php" class="btn btn-info btn-lg" type="button" onclick="<?php echo session_destroy(); ?>">INICIO</a>
                </div>
                </div>
            </div>
        </div>
